...
/*・フォームの onSubmit プロパティに handleSubmit 関数を指定しています。フォームが送信されると、handleSubmit 関数が呼び出されます。
・input 要素は、value プロパティで email と password のステート変数とバインドされ、ユーザーの入力を反映します。
・ユーザーがメールアドレスとパスワードを入力し、ログインボタンをクリックすると、フォームが送信されます。*/